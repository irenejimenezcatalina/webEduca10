(function () {
  ...
  function renderGeneric(page) {
    ...
    const cefrDiagram = pageId === "cambridge" ? `<figure class="cambridge-cefr"><img src="assets/images/cambridge-cefr-qualifications.png" alt="Diagrama visual de las titulaciones Cambridge English y su equivalencia con los niveles del Marco Común Europeo" loading="lazy"><figcaption>Equivalencia visual de niveles y titulaciones Cambridge English</figcaption></figure>` : "";
    ...
    return `${pageHero(page)}${schedulesBlock}
      <section class="section"><div class="container content-grid">
        ...
        <aside class="page-sidebar reveal"><div class="info-card"><span class="info-card__label">Te orientamos</span><h3>${page.sideTitle}</h3><p>${page.sideText}</p><a class="button button--aqua" href="/contacto?interes=${encodeURIComponent(page.title)}">Pedir información ${icons.arrow}</a></div>${cefrDiagram}</aside>
      </div></section>
      ${related}
      ${renderCta()}`;
  }
