(function () {
  ...
  const pages = {
    ...
    cambridge: {
      ...
      heroLogo: "assets/images/logo-cambridge-english-v2.png",
  ...
  const pageMedia = {
    ...
    cambridge: ["assets/images/certificado-centro-preparador-cambridge-v2.jpg", "Certificado oficial de Cambridge English que acredita a Educa10 como centro de preparación"],
    "ingles-adultos": ["assets/images/cartel-ingles-adultos.jpg", "Cartel de clases de inglés para adultos en grupos reducidos y horario de mañanas"],
  ...
  function pageHero(page) {
    ...
    const title = page.heroLogo ? `<div class="page-hero__title-row"><h1>${page.title}</h1><img src="${page.heroLogo}" alt="Cambridge English" loading="eager"></div>` : `<h1>${page.title}</h1>`;
    return `<section class="page-hero"><div class="container"><div class="page-hero__content">${breadcrumbs(page)}<p class="eyebrow">${page.eyebrow}</p>${title}<p class="lead">${page.lead}</p><ul class="tag-list" aria-label="Características">${tags}</ul></div></div></section>`;
  }
  ...
  function renderGeneric(page) {
    ...
    const mediaBlock = pageId === "ingles-ninos" ? "" : media ? `<figure class="content-media${pageId === "musibaby" ? " content-media--poster" : ""}${pageId === "ingles-adultos" ? " content-media--poster content-media--adult-poster" : ""}${pageId === "cambridge" ? " content-media--certificate" : ""}"><img src="${media[0]}" alt="${media[1]}" loading="lazy">${mediaCaption}</figure>` : "";
    const schedulesBlock = pageId === "ingles"
      ? `<section class="section schedules-section" id="horarios"><div class="container"><div class="section-heading schedules-heading"><div><p class="eyebrow">Curso 2026-2027</p><h2>Horarios de inglés</h2></div><div><p class="lead">Consulta los horarios de las aulas y descarga el documento completo.</p><a class="button button--aqua" href="assets/documents/horarios-ingles-2026-2027.pdf" download>Horarios ${icons.arrow}</a></div></div><div class="schedules-gallery"><figure><a href="assets/images/horario-ingles-carmen-aula-1-2026-2027.jpg" target="_blank" rel="noopener"><img src="assets/images/horario-ingles-carmen-aula-1-2026-2027.jpg" alt="Horario de inglés de Carmen en el Aula 1 para el curso 2026-2027"></a><figcaption>Carmen · Aula 1</figcaption></figure><figure><a href="assets/images/horario-ingles-isabel-aula-2-2026-2027.jpg" target="_blank" rel="noopener"><img src="assets/images/horario-ingles-isabel-aula-2-2026-2027.jpg" alt="Horario de inglés de Isabel en el Aula 2 para el curso 2026-2027"></a><figcaption>Isabel · Aula 2</figcaption></figure></div></div></section>`
      : pageId === "refuerzo-escolar"
        ? `<section class="section schedules-section" id="horarios"><div class="container"><div class="section-heading schedules-heading"><div><p class="eyebrow">Curso 2026-2027</p><h2>Horarios de Refuerzo Escolar</h2></div><div><p class="lead">Consulta los grupos y horarios de Refuerzo Escolar y Técnicas de Estudio.</p><a class="button button--aqua" href="assets/documents/horario-refuerzo-escolar-2026-2027.pdf" download>Horarios ${icons.arrow}</a></div></div><div class="schedules-gallery schedules-gallery--single"><figure><a href="assets/images/horario-refuerzo-raquel-aula-3-2026-2027.jpg" target="_blank" rel="noopener"><img src="assets/images/horario-refuerzo-raquel-aula-3-2026-2027.jpg" alt="Horario actualizado de Refuerzo Escolar de Raquel en el Aula 3 para el curso 2026-2027"></a><figcaption>Refuerzo Escolar · Raquel · Aula 3 · Curso 2026-2027</figcaption></figure></div></div></section>`
        : "";
    ...
    const cefrDiagram = pageId === "cambridge" ? `<section class="section section--compact cambridge-cefr-section"><div class="container"><figure class="cambridge-cefr reveal"><img src="assets/images/cambridge-cefr-qualifications.png" alt="Diagrama visual de las titulaciones Cambridge English y su equivalencia con los niveles del Marco Común Europeo" loading="lazy"><figcaption>Equivalencia visual de niveles y titulaciones Cambridge English</figcaption></figure></div></section>` : "";
    const glpShowcase = pageId === "ingles-ninos" ? `<section class="section glp-showcase" aria-labelledby="glp-showcase-title"><div class="container"><div class="glp-showcase__intro reveal"><img class="glp-showcase__logo" src="assets/images/glp-logotipo-principal.png" alt="Great Little People, English early learning"><div><p class="eyebrow">Inglés de 3 a 7 años</p><h2 id="glp-showcase-title">Aprender inglés jugando, explorando y creando</h2><p class="lead">Una metodología 360, íntegramente en inglés, que une aula, familia y materiales para convertir cada sesión en una experiencia activa y emocionante.</p></div></div><div class="glp-showcase__video-wrap reveal"><div class="glp-showcase__video-copy"><img src="assets/images/glp-isologo.png" alt="GLP" class="glp-showcase__isologo"><h3>Así vivimos Great Little People en Educa10</h3><p>Juego, movimiento, fonética, creatividad y materiales sensoriales adaptados a cada etapa.</p></div><video class="glp-showcase__video" controls playsinline preload="metadata" poster="assets/images/video-glp-portada.jpg"><source src="assets/videos/video-promocion-glp-educa10.mp4" type="video/mp4">Tu navegador no puede reproducir este vídeo.</video></div><div class="glp-showcase__infographics" aria-label="Infografías de la metodología Great Little People"><figure class="reveal"><a href="assets/images/infografia-glp-metodologia-1.jpg" target="_blank" rel="noopener"><img src="assets/images/infografia-glp-metodologia-1.jpg" alt="Infografía sobre la metodología de inglés Great Little People para niños de 3 a 7 años" loading="lazy"></a><figcaption>Nuestra metodología de inglés de 3 a 7 años</figcaption></figure><figure class="reveal"><a href="assets/images/infografia-glp-metodologia-2.jpg" target="_blank" rel="noopener"><img src="assets/images/infografia-glp-metodologia-2.jpg" alt="Infografía sobre los rincones, materiales, certificados y evaluaciones de Great Little People" loading="lazy"></a><figcaption>Rincones, materiales y seguimiento del aprendizaje</figcaption></figure></div></div></section>` : "";

    return `${pageHero(page)}${schedulesBlock}${cefrDiagram}${glpShowcase}
      <section class="section"><div class="container content-grid">
        ...
        <aside class="page-sidebar reveal"><div class="info-card"><span class="info-card__label">Te orientamos</span><h3>${page.sideTitle}</h3><p>${page.sideText}</p><a class="button button--aqua" href="/contacto?interes=${encodeURIComponent(page.title)}">Pedir información ${icons.arrow}</a></div></aside>
      </div></section>
      ${related}
      ${renderCta()}`;
  }
  ...
  function renderHome() {
    ...
    return `
      ...
      <section class="section section--paper-deep" id="verano"><div class="container summer-feature"><div class="summer-feature__image reveal"><img src="assets/images/promo-escuela-verano-sin-nina-v2.jpg" alt="Niños disfrutando de los juegos de agua en la Escuela de Verano de Educa10" loading="lazy"></div><div class="reveal"><p class="eyebrow">Gracias por este verano</p><h2>Ha sido un verano increíble</h2><p class="lead">Gracias a las familias, al equipo y a todas las personas que han llenado la Escuela de Verano 2026 de aprendizaje, amistad y diversión.</p><a class="button button--aqua" href="/escuela-verano">Leer nuestro agradecimiento ${icons.arrow}</a></div></div></section>
  ...
  function renderAbout() {
    ...
    return `${pageHero(page)}
      ...
      <section class="section"><div class="container"><div class="section-heading"><div><p class="eyebrow">Nuestro equipo</p><h2>Personas que enseñan y siguen aprendiendo</h2></div><p class="lead">Un equipo coordinado, interdisciplinar y en formación continua.</p></div><div class="team-grid team-grid--grouped"><article class="team-card team-card--rosa reveal"><img src="assets/images/team-rosa.jpg" alt="Rosa Portas" loading="lazy"><div class="team-card__body"><span>Dirección y gerencia</span><h3>Rosa Portas</h3></div></article><article class="team-card reveal"><img src="assets/images/team-catina.jpg" alt="Catina Torres" loading="lazy"><div class="team-card__body"><span>Jefa de estudios</span><h3>Catina Torres</h3><p>Coordinación de profesorado, monitores y actividades.</p></div></article><article class="team-card reveal"><img src="assets/images/team-isabel.jpg" alt="Isabel, profesora de inglés" loading="lazy"><div class="team-card__body"><span>Profesora de inglés</span><h3>Isabel</h3><p>Soy licenciada en Filología Inglesa y tengo el Máster de Profesorado. Me considero una buena persona, comprensiva y empática con los demás. Tengo mucha paciencia y, sobre todo, muchas ganas de enseñar. ¡Nos lo vamos a pasar genial en las clases!</p></div></article><article class="team-card reveal"><img src="assets/images/team-carmen.jpg" alt="Carmen, profesora de inglés" loading="lazy"><div class="team-card__body"><span>Profesora de inglés</span><h3>Carmen</h3><p>Mi nombre es Carmen, soy graduada en Filología Hispánica y tengo un Máster en Español como Lengua Extranjera. Cuento con un nivel B2 de inglés, lo que me permite desenvolverme en contextos bilingües y apoyar mejor el aprendizaje de mis alumnos. Me considero cercana, con vocación docente y comprometida con ofrecer una enseñanza clara y motivadora. ¡Disfrutaremos un montón!</p></div></article><article class="team-card reveal"><img src="assets/images/team-raquel.jpg" alt="Raquel, profesora de refuerzo" loading="lazy"><div class="team-card__body"><span>Profesora de refuerzo</span><h3>Raquel</h3><p>Soy graduada en Bellas Artes y tengo un Máster en Formación del Profesorado. Mis conocimientos artísticos harán que el aprendizaje en el aula sea creativo y divertido, adecuándose siempre a las necesidades de cada alumno. Tengo muchas ganas de enseñar y aprender con vosotros. ¡Nos lo pasaremos genial!</p></div></article></div></div></section>
  ...
  function renderSummerThanks() {
    const messages = [
      ["assets/images/agradecimiento-familia-1.jpg", "Mensaje de una familia: muchas gracias de corazón; los niños se lo han pasado muy bien y han aprendido muchas cosas"],
      ["assets/images/agradecimiento-familia-2.jpg", "Mensaje de una familia agradeciendo el gran trabajo diario del equipo"],
      ["assets/images/agradecimiento-familia-3.jpg", "Mensaje de una familia: los niños están encantadísimos y nosotros también"]
    ].map(([src, alt]) => `<figure class="thanks-message"><img src="${src}" alt="${alt}" loading="lazy"></figure>`).join("");
    const summerHero = `<section class="page-hero summer-thanks-hero"><div class="container summer-thanks-hero__layout"><div class="page-hero__content">${breadcrumbs({ title: "Gracias por este verano" })}<p class="eyebrow">Escuela de Verano 2026</p><h1>Gracias por este verano</h1><p class="lead">La Escuela de Verano 2026 ha llegado a su fin y solo podemos decir: gracias. Ha sido un verano increíble, lleno de aprendizajes, talleres, juegos, nuevas amistades y momentos para recordar.</p><ul class="tag-list" aria-label="Características"><li>Nos vemos en 2027</li></ul></div><figure class="summer-thanks-hero__poster"><img src="assets/images/gracias-escuela-verano-2026.jpg" alt="Cartel de agradecimiento de la Escuela de Verano 2026 de Educa10"></figure></div></section>`;
    return `${summerHero}
  ...
  function renderPage() {
    ...
    else if (pageId === "escuela-verano") app.innerHTML = renderSummerThanks();
