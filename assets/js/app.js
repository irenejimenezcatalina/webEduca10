(function () {
  ...
  function renderGeneric(page) {
    ...
    const mediaBlock = pageId === "ingles-ninos"
      ? `<div class="glp-infographics" aria-label="Metodología Great Little People"><figure class="content-media"><img src="assets/images/metodologia-glp-1.jpg" alt="Infografía sobre la metodología de inglés Great Little People para niños de 3 a 7 años" loading="lazy"></figure><figure class="content-media"><img src="assets/images/metodologia-glp-2.jpg" alt="Infografía de los rincones, materiales y evaluaciones de Great Little People" loading="lazy"></figure></div>`
