(function () {
  ...
  const pageMedia = {
    ingles: ["assets/images/preschool-class.jpg", "Niños pequeños participando en una clase", "Anna Zwiefel", "LgPGzbVmD-o"],
    ...
    cambridge: ["assets/images/child-study.jpg", "Alumno concentrado leyendo y estudiando", "Michał Parzuchowski", "BPXSTl_HBhk"],
    ...
    eso: ["assets/images/child-study.jpg", "Estudiante trabajando con un libro", "Michał Parzuchowski", "BPXSTl_HBhk"],
    "tecnicas-estudio": ["assets/images/child-study.jpg", "Alumno aplicando técnicas de lectura", "Michał Parzuchowski", "BPXSTl_HBhk"],
    talleres: ["assets/images/creative-class.jpg", "Actividad creativa en un aula", "Ahmadreza Rezaie", "FxzoAr9QBKw"],
    musibaby: ["assets/images/preschool-class.jpg", "Niños pequeños en una actividad compartida", "Anna Zwiefel", "LgPGzbVmD-o"],
  ...
  function renderHome() {
    ...
    return `
      <section class="hero"><div class="container hero__grid">
        ...
        <div class="hero__visual"><div class="hero__blob"></div><img class="hero__photo hero__photo--logo" src="docs/Eduquito con logo Educa.jpg" alt="Logo de Educa10 con su personaje Eduquito"></div>
      </div></section>
      ...
      <section class="section section--aqua"><div class="container about-split"><div class="photo-frame reveal"><img src="docs/Fachada Educa 10.jpeg" alt="Fachada del centro Educa10 en Sant Agustí"></div><div class="reveal"><p class="eyebrow">Quiénes somos</p><h2>Un equipo interdisciplinar</h2><p class="lead">Maestros, profesores de distintas materias y profesionales de la educación trabajan para ofrecer sesiones de calidad adaptadas a los diferentes niveles de aprendizaje.</p><ul class="check-list"><li>Calidad, cercanía y profesionalidad.</li><li>Desarrollo integral, autonomía y confianza.</li><li>Aprendizaje divertido, creativo y educativo.</li></ul><div class="button-row"><a class="button" href="quienes-somos.html">Conócenos ${icons.arrow}</a></div></div></div></section>
